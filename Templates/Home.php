        ...
        <div class="container">
            <form action="" method="POST">
                <h4 class="rounded" style="border-bottom: solid 3px #365899; color: #E8E8E8;">
                    <div class="mt-2 p-1 bg-main rounded" style="width: 280px; background: #365899">DANH SÁCH SẢN PHẨM</div>
                </h4>
                        ...
                        <div class="product">
                            <div class="product-details">
                                <div class="image-shoe">
                                    <img class="image" style="width:200px; height:200px" src="Image/product/<?php echo $row['id_product'];?>/<?php echo $row['image'];?>" alt="">
                                    <div class="middle">
